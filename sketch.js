...
function draw() {
  ...
  if(gameState == 0){
    ...
    text("The rules are simple: Press the right arrow to start and the up arrow to jump. Press space to shoot projectiles to defeat enemies. Kill the snake to win!", displayWidth/4.1, 165)
